...
@pytest.mark.parametrize('arguments',
                         [(-7, -2, 1, 6, 5, 8, 7, None, False, [-7, -2, 1, 5, 6, 7, 8]),
                          (-7, -4, 1, 2, 3, 4, 5, 6, None, True, [6, 5, 4, 3, 2, 1, -4, -7]),
                          (-7, -2, 1, 4, 5, 6, abs, False, [1, -2, 4, 5, 6, -7]),
                          (-7, -4, 1, 2, 3, 4, 5, 6, abs, True, [-7, 6, 5, -4, 4, 3, 2, 1]),
                          ('a', 'b', 'b', 'd', 'ab', None, True, ['d', 'b', 'b', 'ab', 'a']),
                          ('a', 'b', 'b', 'x', 'ab', None, False, ['a', 'ab', 'b', 'b', 'x']),
                          ])
