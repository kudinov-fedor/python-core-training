...
@my_parametrised_decorator('gnome_sort')
...
@my_parametrised_decorator('insert_sort')
...
@my_parametrised_decorator('select_sort')
...
if __name__ == "__main__":
    ...
    for func in [bubble_sort, gnome_sort, insert_sort, select_sort]:
        for rev in [True, False]:
            print(func(rand_range, reverse=rev) == sorted(rand_range, reverse=rev))
