...
def calculate_time_spent(func):
    def inner(*args, **kwargs):
        #  1. Know what time was before func started
        start = time.time_ns()
        func(*args, **kwargs)
        #  2. Calculate time after - time started
        time_spent = time.time_ns() - start
        time_spent_seconds = time_spent / 1e9
        print("The function took: ", time_spent_seconds, " seconds.")
    return inner
