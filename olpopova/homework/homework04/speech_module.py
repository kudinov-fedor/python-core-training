...
def checkio(num: int) -> str:
    ...
    if length == 1:
        ...
        third = int(str(num)[2])
        robot_speech = find_speech_for_triple_num(num, first, second, third)
...
def find_speech_for_triple_num(num: int, first: int, second: int, third: int):
    ...
    if num % 100 == 0:
        ...
        robot_speech += " " + find_speech_for_double_num(num % 100, second, third)
